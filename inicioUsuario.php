                    ...
                    <div class="box">
                        ...
                        <div class="box-body">
                            <div class="row">
                                ...
                                $A1_video1_teorico  = mysqli_query($conn, "SELECT * FROM videos WHERE categoria = 'teorico' ORDER BY RAND() LIMIT 4;");
                    ...
                    <div class="box">
                        ...
                        <div class="box-body">
                            <div class="row">
                                ...
                                $A1_video1_practico  = mysqli_query($conn, "SELECT * FROM videos WHERE categoria = 'practico' ORDER BY RAND() LIMIT 4;");

                                if ($dataVideo1_practico   = mysqli_fetch_all($A1_video1_practico)) {
                                    $idVideo_1_practico     = $dataVideo1_practico[0][0];
                                    $name_1_practico        = $dataVideo1_practico[0][1];
                                    $descripcion_1_practico = $dataVideo1_practico[0][2];
                                    $categoria_1_practico   = $dataVideo1_practico[0][3];
                                    $url_1_practico         = $dataVideo1_practico[0][4];

                                    $idVideo_2_practico     = $dataVideo1_practico[1][0];
                                    $name_2_practico        = $dataVideo1_practico[1][1];
                                    $descripcion_2_practico = $dataVideo1_practico[1][2];
                                    $categoria_2_practico   = $dataVideo1_practico[1][3];
                                    $url_2_practico         = $dataVideo1_practico[1][4];

                                    $idVideo_3_practico     = $dataVideo1_practico[2][0];
                                    $name_3_practico        = $dataVideo1_practico[2][1];
                                    $descripcion_3_practico = $dataVideo1_practico[2][2];
                                    $categoria_3_practico   = $dataVideo1_practico[2][3];
                                    $url_3_practico         = $dataVideo1_practico[2][4];

                                    $idVideo_4_practico     = $dataVideo1_practico[3][0];
                                    $name_4_practico        = $dataVideo1_practico[3][1];
                                    $descripcion_4_practico = $dataVideo1_practico[3][2];
                                    $categoria_4_practico   = $dataVideo1_practico[3][3];
                                    $url_4_practico         = $dataVideo1_practico[3][4];
                                }
                                //}
                                ?>
                                <!-- Video practico 1 -->
                    ...
                    <div class="box">
                        ...
                        <div class="box-body">
                            <div class="row">
                                ...
                                $A1_video1_ejercicios  = mysqli_query($conn, "SELECT * FROM videos WHERE categoria = 'ejercicios' ORDER BY RAND() LIMIT 4;");

                                if ($dataVideo1_ejercicios   = mysqli_fetch_all($A1_video1_ejercicios)) {
                                    $idVideo_1_ejercicios     = $dataVideo1_ejercicios[0][0];
                                    $name_1_ejercicios        = $dataVideo1_ejercicios[0][1];
                                    $descripcion_1_ejercicios = $dataVideo1_ejercicios[0][2];
                                    $categoria_1_ejercicios   = $dataVideo1_ejercicios[0][3];
                                    $url_1_ejercicios         = $dataVideo1_ejercicios[0][4];

                                    $idVideo_2_ejercicios     = $dataVideo1_ejercicios[1][0];
                                    $name_2_ejercicios        = $dataVideo1_ejercicios[1][1];
                                    $descripcion_2_ejercicios = $dataVideo1_ejercicios[1][2];
                                    $categoria_2_ejercicios   = $dataVideo1_ejercicios[1][3];
                                    $url_2_ejercicios         = $dataVideo1_ejercicios[1][4];

                                    $idVideo_3_ejercicios     = $dataVideo1_ejercicios[2][0];
                                    $name_3_ejercicios        = $dataVideo1_ejercicios[2][1];
                                    $descripcion_3_ejercicios = $dataVideo1_ejercicios[2][2];
                                    $categoria_3_ejercicios   = $dataVideo1_ejercicios[2][3];
                                    $url_3_ejercicios         = $dataVideo1_ejercicios[2][4];

                                    $idVideo_4_ejercicios     = $dataVideo1_ejercicios[3][0];
                                    $name_4_ejercicios        = $dataVideo1_ejercicios[3][1];
                                    $descripcion_4_ejercicios = $dataVideo1_ejercicios[3][2];
                                    $categoria_4_ejercicios   = $dataVideo1_ejercicios[3][3];
                                    $url_4_ejercicios         = $dataVideo1_ejercicios[3][4];
                                }
                                //}
                                ?>
                                <!-- Video ejercicios 1 -->
                    ...
                    <div class="box">
                        ...
                        <div class="box-body">
                            <div class="row">
                                ...
                                //$idVideo_1_temp = $dataVideo1_temp['idVideo'];
                                $A1_video1_documentales  = mysqli_query($conn, "SELECT * FROM videos WHERE categoria = 'documentales' ORDER BY RAND() LIMIT 4;");

                                if ($dataVideo1_documentales   = mysqli_fetch_all($A1_video1_documentales)) {
                                    $idVideo_1_documentales     = $dataVideo1_documentales[0][0];
                                    $name_1_documentales        = $dataVideo1_documentales[0][1];
                                    $descripcion_1_documentales = $dataVideo1_documentales[0][2];
                                    $categoria_1_documentales   = $dataVideo1_documentales[0][3];
                                    $url_1_documentales         = $dataVideo1_documentales[0][4];

                                    $idVideo_2_documentales     = $dataVideo1_documentales[1][0];
                                    $name_2_documentales        = $dataVideo1_documentales[1][1];
                                    $descripcion_2_documentales = $dataVideo1_documentales[1][2];
                                    $categoria_2_documentales   = $dataVideo1_documentales[1][3];
                                    $url_2_documentales         = $dataVideo1_documentales[1][4];

                                    $idVideo_3_documentales     = $dataVideo1_documentales[2][0];
                                    $name_3_documentales        = $dataVideo1_documentales[2][1];
                                    $descripcion_3_documentales = $dataVideo1_documentales[2][2];
                                    $categoria_3_documentales   = $dataVideo1_documentales[2][3];
                                    $url_3_documentales         = $dataVideo1_documentales[2][4];

                                    $idVideo_4_documentales     = $dataVideo1_documentales[3][0];
                                    $name_4_documentales        = $dataVideo1_documentales[3][1];
                                    $descripcion_4_documentales = $dataVideo1_documentales[3][2];
                                    $categoria_4_documentales   = $dataVideo1_documentales[3][3];
                                    $url_4_documentales         = $dataVideo1_documentales[3][4];
                                }
                                //}
                                ?>
                    ...
                    <div class="box">
                        ...
                        <div class="box-body">
                            <div class="row">
                                ...
                                $A1_video1_biografias  = mysqli_query($conn, "SELECT * FROM videos WHERE categoria = 'biografias' ORDER BY RAND() LIMIT 4;");

                                if ($dataVideo1_biografias   = mysqli_fetch_all($A1_video1_biografias)) {
                                    $idVideo_1_biografias     = $dataVideo1_biografias[0][0];
                                    $name_1_biografias        = $dataVideo1_biografias[0][1];
                                    $descripcion_1_biografias = $dataVideo1_biografias[0][2];
                                    $categoria_1_biografias   = $dataVideo1_biografias[0][3];
                                    $url_1_biografias         = $dataVideo1_biografias[0][4];

                                    $idVideo_2_biografias     = $dataVideo1_biografias[1][0];
                                    $name_2_biografias        = $dataVideo1_biografias[1][1];
                                    $descripcion_2_biografias = $dataVideo1_biografias[1][2];
                                    $categoria_2_biografias   = $dataVideo1_biografias[1][3];
                                    $url_2_biografias         = $dataVideo1_biografias[1][4];

                                    $idVideo_3_biografias     = $dataVideo1_biografias[2][0];
                                    $name_3_biografias        = $dataVideo1_biografias[2][1];
                                    $descripcion_3_biografias = $dataVideo1_biografias[2][2];
                                    $categoria_3_biografias   = $dataVideo1_biografias[2][3];
                                    $url_3_biografias         = $dataVideo1_biografias[2][4];

                                    $idVideo_4_biografias     = $dataVideo1_biografias[3][0];
                                    $name_4_biografias        = $dataVideo1_biografias[3][1];
                                    $descripcion_4_biografias = $dataVideo1_biografias[3][2];
                                    $categoria_4_biografias   = $dataVideo1_biografias[3][3];
                                    $url_4_biografias         = $dataVideo1_biografias[3][4];
                                }
                                //}
                                ?>
                                <!-- Video biografias 1 -->
